...
func addDataAktivitas(){
    let aktivitas1 = aktivitas(idAktivitas: "1", idAkun: "1", namaAktivitas: "Berlatih Indera", descAktivitas: "Beri mainan benda yang besar dan berwarna", fotoAktivitas: UIImage(imageLiteralResourceName: "hold"))
    let aktivitas2 = aktivitas(idAktivitas: "2", idAkun: "1", namaAktivitas: "Jalan-Jalan", descAktivitas: "Bawa bayi anda berkeliling mengenali lingkungan sekitar", fotoAktivitas: UIImage(imageLiteralResourceName: "walk"))
    let aktivitas3 = aktivitas(idAktivitas: "3", idAkun: "1", namaAktivitas: "Mengenal Bunyi", descAktivitas: "Perkenalkan bayi anda dengan bunyi-bunyian", fotoAktivitas: UIImage(imageLiteralResourceName: "music"))
    let aktivitas4 = aktivitas(idAktivitas: "4", idAkun: "1", namaAktivitas: "Bermain", descAktivitas: "Bermain dengan benda yang kecil dan aman dipukul-pukul oleh si kecil", fotoAktivitas: UIImage(imageLiteralResourceName: "play"))
...
func addDataKomunitas(){
    let community1 = komunitas(idKomunitas: "1", IdAkun: "1", namaKomunitas: "Grup Bayi Indonesia", descKomunitas: "Siap , Sedia , Laksanakan bantuan jika diperlukan", fotoKomunitas: UIImage(named: "komunitas1")!, linkKomunitas: "https://t.me/joinchat/DRouLxOEK0-GHBJu76Bd6A")
    let community2 = komunitas(idKomunitas: "2", IdAkun: "1", namaKomunitas: "Grup Bayi MC2", descKomunitas: "Membantu anda dalam kesulitan dan kesusahan disaat merawat bayi", fotoKomunitas: UIImage(named: "komunitas2")!, linkKomunitas: "https://t.me/joinchat/DRouLxOEK0-GHBJu76Bd6A")
    let community3 = komunitas(idKomunitas: "3", IdAkun: "1", namaKomunitas: "Grup Bayi Cohort 2", descKomunitas: "Hidup bayi di tangan kita bukan tetangga , Okeh ", fotoKomunitas: UIImage(named: "komunitas3")!, linkKomunitas: "https://t.me/joinchat/DRouLxOEK0-GHBJu76Bd6A")
